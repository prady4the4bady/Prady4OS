...
ISR_NOERR 49
; MSI-X device vectors (DDR-714C1): per-device message-signaled interrupts,
; delivered straight to the LAPIC (no PIC/IOAPIC). 50..53 = virtio-blk 0..3.
ISR_NOERR 50
ISR_NOERR 51
ISR_NOERR 52
ISR_NOERR 53
...
; Address table consumed by idt_init() in kernel/idt.c (vectors 0..53).
section .rodata
