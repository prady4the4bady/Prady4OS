...
- **Gate count: 161** assigned across **10** shards, **7** excluded — measured by
...
- **`kernel.bin`**: **1,118,602 B** against the 1,572,864 B size gate — 454,262 B
