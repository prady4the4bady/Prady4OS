...
- **Gate count: 160** assigned across **10** shards, **7** excluded — measured by
...
- **`kernel.bin`**: **1,114,506 B** against the 1,572,864 B size gate — 458,358 B
