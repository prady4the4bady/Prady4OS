...
- **Gate count: 162** assigned across **10** shards, **7** excluded — measured by
...
- **`kernel.bin`**: **1,126,794 B** against the 1,572,864 B size gate — 446,070 B
