...
- **Gate count: 163** assigned across **10** shards, **7** excluded — measured by
  `make ci-shard-check` on 2026-08-30, not carried forward. This line read "149"
...
2. **`bash tools/ci/hygiene_check.sh`** — runs ALL THREE static checks
