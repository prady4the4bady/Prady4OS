...
- **Gate count: 166** assigned across **10** shards, **7** excluded — measured by
...
- **NSI max: 97** (`SYS_MPROTECT`, DDR-1031). **Next free: 98.** Table size: 128.
