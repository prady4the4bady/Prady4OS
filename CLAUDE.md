...
Free range: **DDR-1002+** (936-1000 allocated; 999 = multi-arch parity ASSESSMENT (answer: not achievable), 1000 = OPEN-1 DECISION (does not close; E1/E2 named); 998 = SURF_EV_CLOSE, IMPLEMENTED + gated (M3 unmeasured); 997 = resize from any edge, IMPLEMENTED + gated + mutation-checked; 994 = the OPEN-1 route-1 yield-stall detector, IMPLEMENTED + gated; 995 = Alt+Tab, IMPLEMENTED + gated; 996 = TCB freed while queued, FIXED + gated + mutation-checked).
