...
KERNEL_CS   := kernel/main.c kernel/console.c kernel/idt.c kernel/irq.c \
               ...
               kernel/proc/sched.c kernel/proc/tss.c kernel/proc/fd.c kernel/proc/pipe.c kernel/ipc/ipc.c \
...
KERNEL_OBJS := build/boot.o build/cpu.o build/isr.o build/context.o \
               ...
               build/vmm.o build/vmm_cow.o build/uaccess.o build/cap.o build/sched.o build/tss.o build/fd.o build/pipe.o build/ipc.o \
