...
KERNEL_CS   := kernel/main.c kernel/console.c kernel/idt.c kernel/irq.c \
               ...
               kernel/ipc/bcast.c kernel/syscall/syscall.c kernel/syscall/sys_io.c kernel/syscall/sys_file.c kernel/syscall/sys_proc.c kernel/acpi/acpi.c \
...
KERNEL_OBJS := build/boot.o build/cpu.o build/isr.o build/context.o \
               ...
               build/bcast.o build/syscall.o build/sys_io.o build/sys_file.o build/sys_proc.o build/acpi.o build/pcie.o \
...
.PHONY: all setup toolchain-check kernel image smoke smoke-fs smoke-fs-rw smoke-fs-sfs-rw smoke-fs-ext4 smoke-user smoke-uaccess smoke-sysio smoke-sysfile smoke-sysproc fat-image sfs-image ext4-image clean
